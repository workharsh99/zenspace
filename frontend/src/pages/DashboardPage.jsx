          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="card p-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  ...
                  <div className="text-center p-4 bg-purple-50 rounded-xl">
                    ...
                    <div className="text-slate-500 text-sm mt-1">Avg Rating</div>
                  </div>
                </div>
                  ...
                  <div className="mt-5">
                    ...
                    <div className="space-y-2">
                      {Object.entries(stats.sessionsByCategory).map(([cat, count]) => {
                        const pct = Math.round((count / (stats.completedSessions || 1)) * 100);
                        return (
                          <div key={cat} className="flex items-center gap-3">
                            <span className="text-sm w-28 text-slate-600">{categoryEmojis[cat] || '🧘'} {cat}</span>
                            <div className="flex-1 bg-slate-100 rounded-full h-2">
                              <div className="bg-wellness-500 h-2 rounded-full" style={{ width: `${pct}%` }} />
                            </div>
            ...
            <div className="card p-6">
              <div className="flex items-center justify-between mb-5">
                ...
                <Link to="/sessions" className="text-wellness-600 text-sm hover:text-wellness-700 font-medium">View All →</Link>
              </div>
              {recentSessions.length > 0 ? (
                ...
                <div className="text-center py-8 text-slate-400">
                  ...
                  <Link to="/activities" className="btn-primary text-sm mt-3 inline-block">Browse Activities</Link>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="card p-6 bg-gradient-to-br from-wellness-50 to-calm-50 border-wellness-100">
              ...
              <p className="text-wellness-700 text-sm leading-relaxed">
                Consistency is key! Even 5 minutes of daily meditation can significantly reduce stress levels.
