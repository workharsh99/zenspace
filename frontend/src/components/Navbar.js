      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <div className="w-9 h-9 bg-gradient-to-br from-wellness-500 to-calm-500 rounded-xl flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow">
        ...
        {/* Mobile Menu */}
        {isMobileOpen && (
          <div className="md:hidden bg-white border-t border-slate-100 py-4 px-2 space-y-1 animate-fade-in">
            {navLinks.map(link => (
              <Link
                key={link.to}
                to={link.to}
