    ...
    <Link to={`/activities/${activity.id}`} className="card-hover group block">
      <div className="relative h-48 overflow-hidden">
        ...
        <div className="absolute top-3 left-3">
          <span className={`badge ${config.color} shadow-sm`}>{config.emoji} {activity.category}</span>
        </div>
        {activity.featured && (
      ...
      <div className="p-5">
        ...
        <p className="text-slate-500 text-sm leading-relaxed line-clamp-2 mb-4">{activity.description}</p>
